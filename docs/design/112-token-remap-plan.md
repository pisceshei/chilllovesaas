...
| 項 | 我方現況 | 本尊 | 處置 |
|---|---|---|---|
| **`--col-main:633px`／`--col-aside:317px`** | 固定欄寬 | 🔴 **本尊內容區 `max-width: none`，流體寬**（111 §16.1）。2026-08-28 補：≥1040 有 58 條規則、≥1200 有 16 條、≥1440 有 43 條翻面，但**多數是 Polaris 的變數 fallback 階梯**——元件沒宣告 `-lg`／`-xl` 就等於沒做 | **待裁定**：改流體會動到所有頁面佈局 |
