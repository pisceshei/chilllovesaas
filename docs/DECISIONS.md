...
- 2026-08-19 裁定：本互動式 Codex 工作階段獲准實作、commit、push 並送 GitHub 驗收。
- 廢止範圍是 workflow 內的自動 `@codex` 派修乒乓，不是「Codex 永不實作」；不得把該機制加回。
...
- 不以減少 PR 數為由綁定無共同依賴、無單一驗收標準的工作；每包各自 worklog、handoff、commit 與驗收。
