...
**結論：表內 C-01～C-16 共 16 列，全部成立，但清單仍不完整——另遺漏至少 10 條，補列如下。**
...
**表 3 缺口數：`26`**（C-01～C-16 共 16 列 ＋ T-01～T-10 共 10 列）。複驗：
`ruby -EUTF-8:UTF-8 -e 's=File.read("docs/specs/50-logic-gap-register.md"); p({c:s.scan(/^\| C-\d{2} /).size,t:s.scan(/^\| \*\*T-\d{2}\*\* \|/).size})'`。
...
| 表 3 · 三方衝突 | **26** | C-01～C-16 共 16 列＋T-01～T-10 共 10 列 |
| 表 4 · API↔UI | **132** | 正向 32（孤兒 24＋TBD 8）＋反向 59（孤兒 16＋應刪/標 4＋28 缺 39）＋未結案 TBD 41 |
| 表 5 · 台灣落地 | **27** | 10 個主項下的可實作性缺口逐條計 |
| **合計** | **314** | 其中 **P0 15 條**、**P1 下游 33 條**、**必須查證 10 組**；五表加總複驗見 `docs/specs/92-claim-index.md` CLAIM-001 |
