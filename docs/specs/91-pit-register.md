...
🔴 命名空間聲明（第 10 輪立、第 11 輪去枚舉——原句枚舉 16／55／57 在寫下當刻即
窄於本檔實引（15 §F5、19 F1）且 G 側實況達 G-24 與 71 號 Gxx 形）：**本檔 F-xx
（形態）與 §2 G-xx（閘門缺口）皆為 91 內部編號——與其他任何檔的 F-xx 節號、
G-xx／Gxx 缺口編號一律無關**；本檔內引用外部節號一律帶檔名前綴（「16 §F5」形），
【F#】方括號形保留給本檔形態標記。
