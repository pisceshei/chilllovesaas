...
2. `docs/handoff/2026-08-24-總交接.md`——**最重要的一份**：環境操作手冊、未結事項總帳、
   ...
   ⇒ **2026-09-05 起：先讀 `docs/plans/2026-09-05-全對齊路線圖.md`（D84 總目標與狀態板），再讀
   `docs/handoff/2026-09-04-總交接-語言前綴本尊形後.md`**（環境／紅線／工具）；以下為更早的指標 ⇒ 2026-09-04 起現況以 `docs/handoff/2026-09-04-總交接-編輯器對表與國家字典.md` 為準（主題編輯器對表收口、本尊編輯器渲染 A′、
   國家字典五語言、真店五語言五市場、D80 待裁定、下一包順序）；本檔 §2 的數字停在 2026-08-24。
