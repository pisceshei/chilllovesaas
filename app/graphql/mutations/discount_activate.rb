...
module Mutations
  # 折扣啟用（官方分 code/automatic 兩支——ours 合一：admin SPA 唯一客戶端，
  # method 已在資料列上；PR 描述明載）。
  class DiscountActivate < BaseMutation
    graphql_name "DiscountActivate"
    description "啟用折扣（status → active；時間窗照舊推導）。"
